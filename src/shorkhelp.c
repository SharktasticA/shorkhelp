...
void printIntro(void)
{
    ...
    pos += snprintf(introStr + pos, strSize - pos, "\033[%smLicences\033[%sm\nSHORK 486 is a free and open-source operating system. Its core is made up of GPLv3 (SHORK, SHORK Utilities, SHORK Entertainment) and GPLv2 (Linux kernel, BusyBox, SYSLINUX) components. SHORK 486 can also contain bundled software licensed under various permissive, copyleft, and even public-domain-equivalent licences. You can look at \033[%smshorkhelp\033[%sm's \"Licences\" portal to see their licences.", COL_FOR_HEADING, COL_FOR_WHITE, COL_FOR_SHORKUTIL, COL_FOR_RESET);
