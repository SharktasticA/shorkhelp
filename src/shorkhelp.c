...
{
    char *magenta = COL_ENABLED ? COL_FOR_MAGENTA : COL_FOR_RESET;
    char *red = COL_ENABLED ? COL_FOR_RED : COL_FOR_RESET;
...
\033[%smFind and replace\033[%sm       \033[%smM\033[%sm-%%        \033[%smReformat (fit to line)\033[%sm    \033[%smM\033[%sm-q\n",
    red, COL_FOR_WHITE, magenta, COL_FOR_WHITE,
    COL_FOR_OL, COL_FOR_WHITE, red, COL_FOR_WHITE, red, COL_FOR_WHITE, COL_FOR_OL, COL_FOR_WHITE, red, COL_FOR_WHITE, red, COL_FOR_WHITE,
    COL_FOR_OL, COL_FOR_WHITE, red, COL_FOR_WHITE, red, COL_FOR_WHITE, COL_FOR_OL, COL_FOR_WHITE, red, COL_FOR_WHITE,
    COL_FOR_OL, COL_FOR_WHITE, red, COL_FOR_WHITE, COL_FOR_OL, COL_FOR_WHITE, red, COL_FOR_WHITE,
    COL_FOR_OL, COL_FOR_WHITE, red, COL_FOR_WHITE, COL_FOR_OL, COL_FOR_WHITE, red, COL_FOR_WHITE,
    COL_FOR_OL, COL_FOR_WHITE, red, COL_FOR_WHITE,
    COL_FOR_OL, COL_FOR_WHITE, red, COL_FOR_WHITE, COL_FOR_OL, COL_FOR_WHITE, red, COL_FOR_WHITE,
    COL_FOR_OL, COL_FOR_WHITE, red, COL_FOR_WHITE, COL_FOR_OL, COL_FOR_WHITE, red, COL_FOR_WHITE,
    COL_FOR_OL, COL_FOR_WHITE, magenta, COL_FOR_WHITE, COL_FOR_OL, COL_FOR_WHITE, magenta, COL_FOR_WHITE);
